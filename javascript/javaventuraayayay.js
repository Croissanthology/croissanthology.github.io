...
document.addEventListener('mouseup', (e) => {
    ...
    if (text) {
        ...
        // Create the link with properly encoded parameters
        popup.innerHTML = `<a 
            href="mailto:croissanthology@gmail.com?subject=${subject}&body=${body}"
            onclick="event.stopPropagation(); event.preventDefault(); this.click();"
            class="feedback-link"
        >💭 Share feedback</a>`;
...
// Hide popup when clicking outside, but don't interfere with the link click
